  ...
  return (
    <div className='w-[50%] h-[70%] bg-slate-200 gap-20  p-10 rounded-b-3xl grid grid-cols-2'>
      <div className='flex gap-5 justify-start'>
        <div className=''>
          <img className='w-32 h-32 mx-4 rounded-full object-scale-down' src='https://media.istockphoto.com/id/964111894/vector/poster-of-the-vinyl-record-vector-illustration-on-dark-background.jpg?s=2048x2048&w=is&k=20&c=D8Oi3fRPP0ieUqZgxrUgq2YMT38yt8nqohE2YzTjTzY=' ></img>
          ...
          <img className='w-32 h-32 mx-4 rounded-full object-scale-down' src='https://media.istockphoto.com/id/845844762/vector/poster-of-the-vinyl-record-vector-illustration-on-dark-background.jpg?s=1024x1024&w=is&k=20&c=AOe_QTKGLSEytxl2oQA9qjSe1mvt9GvxHCZcgtTaQZ4=' ></img>
        </div>
        <div className=''>
          <img className='w-32 h-32 rounded-full object-scale-down' src='https://media.istockphoto.com/id/845844160/vector/poster-of-the-vinyl-record-vector-illustration-on-dark-background.jpg?s=1024x1024&w=is&k=20&c=Y11nqKc1moU_w7J_IvPoe56MDlhJ4MPdn7DHT2FiM9A=' ></img>
